...
class KarateTerminologyActivityArchitectureTest {
    ...
    @Test fun recognizedOsuTriggersFrontCameraCaptureAndResultEvidence() {
        ...
        assertTrue(camera.contains("SharedCameraCaptureBackend"))
        assertTrue(camera.contains("SharedCaptureRequests.readyOsuSelfie"))
        assertFalse(camera.contains("ProcessCameraProvider"))
        ...
        assertTrue(activity.contains(".put(\"selfiePersisted\", readyOsuCaptureResult?.mediaFinalized == true)"))
