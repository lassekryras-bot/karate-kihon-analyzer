...
class MotionReplayRunner {
    fun run(fixture: PoseReplayFixture, parameters: MotionReplayParameterSet): MotionReplayResult {
        val extractor = PoseMotionObservationExtractor(
            parameters.extractor.copy(requiredRegions = parameters.requiredRegions),
        )
        val segmenter = GenericMotionSegmenter(
            parameters.segmenter.copy(
                endPoseRelationship = fixture.expectedEndPoseRelationship,
                requiredRegionsForTerminalStillness = parameters.requiredRegions,
            ),
        )
...
object MotionReplayTraceJson {
    ...
    fun encode(result: MotionReplayResult): String = buildString {
        ...
        result.trace.forEachIndexed { index, row ->
            ...
            append("}")
            val kin = observation.kinematics
            if (kin != null) {
                append(",\"kinematics\":{")
                append("\"left_wrist_speed\":"); nullableNumber(kin.leftArm.wristTorsoRelativeSpeed)
                append(",\"left_wrist_radial\":"); nullableNumber(kin.leftArm.wristRadialVelocity)
                append(",\"right_wrist_speed\":"); nullableNumber(kin.rightArm.wristTorsoRelativeSpeed)
                append(",\"right_wrist_radial\":"); nullableNumber(kin.rightArm.wristRadialVelocity)
                append(",\"left_ankle_speed\":"); nullableNumber(kin.leftLeg.ankleTorsoRelativeSpeed)
                append(",\"left_ankle_radial\":"); nullableNumber(kin.leftLeg.ankleRadialVelocity)
                append(",\"right_ankle_speed\":"); nullableNumber(kin.rightLeg.ankleTorsoRelativeSpeed)
                append(",\"right_ankle_radial\":"); nullableNumber(kin.rightLeg.ankleRadialVelocity)
                append(",\"left_knee_speed\":"); nullableNumber(kin.leftLeg.kneeTorsoRelativeSpeed)
                append(",\"left_knee_radial\":"); nullableNumber(kin.leftLeg.kneeRadialVelocity)
                append(",\"right_knee_speed\":"); nullableNumber(kin.rightLeg.kneeTorsoRelativeSpeed)
                append(",\"right_knee_radial\":"); nullableNumber(kin.rightLeg.kneeRadialVelocity)
                append(",\"left_elbow_angle\":"); nullableNumber(kin.leftArm.elbowAngleDegrees)
                append(",\"left_elbow_velocity\":"); nullableNumber(kin.leftArm.elbowAngularVelocityDegPerSec)
                append(",\"right_elbow_angle\":"); nullableNumber(kin.rightArm.elbowAngleDegrees)
                append(",\"right_elbow_velocity\":"); nullableNumber(kin.rightArm.elbowAngularVelocityDegPerSec)
                append(",\"left_knee_angle\":"); nullableNumber(kin.leftLeg.kneeAngleDegrees)
                append(",\"left_knee_velocity\":"); nullableNumber(kin.leftLeg.kneeAngularVelocityDegPerSec)
                append(",\"right_knee_angle\":"); nullableNumber(kin.rightLeg.kneeAngleDegrees)
                append(",\"right_knee_velocity\":"); nullableNumber(kin.rightLeg.kneeAngularVelocityDegPerSec)
                append(",\"left_upper_arm_orientation\":"); nullableNumber(kin.leftArm.upperArmOrientationChangeDegPerSec)
                append(",\"left_forearm_orientation\":"); nullableNumber(kin.leftArm.forearmOrientationChangeDegPerSec)
                append(",\"right_upper_arm_orientation\":"); nullableNumber(kin.rightArm.upperArmOrientationChangeDegPerSec)
                append(",\"right_forearm_orientation\":"); nullableNumber(kin.rightArm.forearmOrientationChangeDegPerSec)
                append(",\"left_thigh_orientation\":"); nullableNumber(kin.leftLeg.thighOrientationChangeDegPerSec)
                append(",\"left_shin_orientation\":"); nullableNumber(kin.leftLeg.shinOrientationChangeDegPerSec)
                append(",\"right_thigh_orientation\":"); nullableNumber(kin.rightLeg.thighOrientationChangeDegPerSec)
                append(",\"right_shin_orientation\":"); nullableNumber(kin.rightLeg.shinOrientationChangeDegPerSec)
                append(",\"pelvis_rotation_3d\":"); nullableNumber(kin.pelvis.rotationRateDegPerSec)
                append(",\"pelvis_rotation_yaw\":"); nullableNumber(kin.pelvis.yawRotationRateDegPerSec)
                append(",\"any_limb_motion\":\"").append(kin.positiveEvidence.anyLimbMotion.name).append('"')
                append(",\"triggering_channels\":[")
                kin.positiveEvidence.triggeringChannels.forEachIndexed { ci, ch ->
                    if (ci > 0) append(',')
                    quote(ch)
                }
                append("]}")
